...
const ALLOWED_ASPECTS = Object.freeze(['original', '16:9', '9:16', '1:1']);
...
export function normalizeVideoEdits(edits, duration) {
  ...
  const outputAspect = ALLOWED_ASPECTS.includes(String(source.outputAspect)) ? String(source.outputAspect) : 'original';

  return { trimStart, trimEnd, playbackRate, muted, outputAspect };
}
