import { actionSpecsFromPlan, parseCommand, planFromActionSpecs, reevaluateAction } from './grammar.js';
  ...
  return {
    loadPlan(actionSpecs, context = {}) {
      ...
      message.textContent = actions.length
        ? `${context.recipeName || 'Recipe'} loaded as Planned Actions. Inspect, reorder or adjust before running.`
