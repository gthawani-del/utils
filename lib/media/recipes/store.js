...
const BUILT_INS = Object.freeze([
  ...
  },
  {
    ...
    name: 'Podcast Clean',
    description: 'Plan dialogue normalization and QC; unsupported normalization stays blocked.',
    actions: [{ type: 'normalize-audio', params: {} }, { type: 'run-qc', params: {} }]
  },
  {
  ...
  {
    id: 'builtin-whatsapp-compress',
    name: 'WhatsApp Compress',
    description: 'Target a smaller delivery file; encoder step remains blocked until implemented.',
    actions: [{ type: 'target-size', params: { megabytes: 16 } }]
  },
  {
  ...
  {
    id: 'builtin-silence-captions',
    name: 'Remove Silence + Captions',
    description: 'Plans both operations without pretending missing engines exist.',
    actions: [{ type: 'remove-silence', params: {} }, { type: 'generate-captions', params: {} }]
  },
  {
